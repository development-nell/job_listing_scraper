use utf8;
package Ext::Schema::Result::CompanyNote;
...
=head1 TABLE: C<company_notes>

=cut

__PACKAGE__->table("company_notes");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WCw7FeI3ttf0FDGhpIl9Yg
